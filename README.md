...
## 10. Схема проекта
![Схема_проекта.png](assets/schema.png)
...
Рассчитаем пиковую нагрузку с запасом на 1 вышедший из строя ДЦ.
Коэффициент выберем  
$K = \frac{L_{макс}}{L_{ср}} (1 + K_x + K_d)$,  
где:  
$L_{макс} = 1188,432$ - RPS на самый загруженный ДЦ,  
$L_{ср} = 990,36$ - средний по ДЦ RPS,    
$K_x = 0.4$ - коэффициент запаса на расширение,  
$K_d = \frac{N_{упав} + 1}{N_{общ} - N_{упав} + 1}$ - коэффициент запаса на падение Nупав (2) ДЦ.  
**K = 2.48**  
Дополнительно учтём походы внутри сервиса.
...
| - | - | - |
| Авторизация | K x 190 = 470 | K x (0,0048 + 0,0048) = 0.024 |
| Пользователи | K x 496 = 1227 | 540 Б * 1227 = 0.005 Гб/с  |
| Геокодирование | K x 170 = 420 | 200 Б * 420 = 0.0007 Гб/с  |
| Маршрутизация | K x 340 = 841 | 12 Б * 841 = 0.00008 Гб/с |
| Геолокация | K x 4094 = 101293 | 0.04 |
| Расчёт стоимости поездки | K x 340 = 841 | 25,3 КБ * 8 * 841 = 0.17 Гб/с |
| Управление поездками | K x 942 = 2331 | 483 * 8 * 2331 = 0.01 |
| Чаты | K x 38 = 94 | 240 Б * 8 * 94 = 0.0001 Гб/с |
| Рейтинг | K x 274 = 678 | 92 Б * 8 * 678 = 0.0005 Гб/с |
| Оплата | K x 152 = 376 | 376 * 8 * 72 Б = 0.0002 Гб/с |
| История поездок | K x 3 = 7 | 0.00004 |
| API-gateway | 111962 | 0.368 |
| S3 | 577 фото + 170 gpx = 747 | 0.942 |
| nginx | 112709 | 1.31 | 

| Сервис      | Целевая пиковая нагрузка, RPS | Сеть, Гбит/с |
| -           |                             - |            - |
| Авторизация | K x 70 = 174                  |              |
|||
|||
|||
|||
