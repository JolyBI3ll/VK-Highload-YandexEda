...
Рассчитаем пиковую нагрузку с коэффициент = 2.
...
| -------------------------- | ----------------------------- | ------------ |
| Авторизация                | 2 × 70 = 140                  | 0.00224      |
| Профиль пользователя       | 2 × 139 = 278                 | 0.00445      |
| Геолокация и поиск курьера | 2 × (23 + 8250) = 16 546      | 0.2647       |
| Запись новых продуктов     | 2 × 0.39 = 0.78               | 0.0000125    |
| Запись новых ресторанов    | 2 × 0.14 = 0.28               | 0.0000045    |
| Отзывы                     | 2 × 3.5 + 173 = 180           | 0.00288      |
| Корзина                    | 2 × 23 = 46                   | 0.000736     |
| Поиск                      | 2 × 1040 + 1040 + 208 = 3 328 | 0.0533       |
| Статистика ресторана       | 2 × 1040 + 23 = 2 103         | 0.0336       |
| История заказов            | 2 × 21 = 42                   | 0.000672     |
| Оплаты                     | 2 × 23 = 46                   | 0.000736     |
| Управление заказами        | 2 × 92 = 184                  | 0.00294      |
| API Gateway                | 22 983                        | 0.3677       |
| Nginx                      | 22 983                        | 0.3677       |
| S3                         | 2 × 1040 + 1040 + 208 = 3 328 | **2.159**    |
...
| -------------------------- | ------ | --------------- | --------- | ------- |
| Авторизация                | 140    | лёгкая          | 1         | 2       |
| Профиль пользователя       | 278    | средняя         | 3         | 28      |
| Геолокация и поиск курьера | 16 546 |	лёгкая          |	17        | 166     |
| Запись новых продуктов     | 0.78   | лёгкая          | 1         | 1       |
| Запись новых ресторанов    | 0.28   | лёгкая          | 1         | 1       |
| Отзывы                     | 180    | средняя         | 2         | 18      |
| Корзина                    | 46     | лёгкая          | 1         | 1       |
| Поиск                      | 3 328  | средняя         | 34        | 333     |
| Статистика ресторана       | 2 103  | средняя         | 22        | 211     |
| История заказов            | 42     | лёгкая          | 1         | 1       |
| Оплаты                     | 46     | средняя         | 1         | 5       |
| Управление заказами        | 184    | средняя         | 2         | 19      |
| API Gateway                | 22 983 | лёгкая          | 23        | 230     |
| Nginx                      | 22 983 | TLS-handshake   | 105       | 154     |

В итоге на **один ДЦ** получим: 
 - 214 ядер CPU
 - 1 170 ГБ RAM

### Рассчет ресурсов по базам данных

| СУБД          | CPU (ядер) | RAM (ГБ) |
| ------------- | ---------- | -------- |
| PostgreSQL    | 44         | 369      |
| Redis         | 11         | 86       |
| ClickHouse    | 22         | 127      |
| Elasticsearch | 34         | 266      |

### Конфигурация сервисных блоков

| Сервисный блок             | Конфигурация сервера                                 | CPU cores | Кол-во на 1 ДЦ | Аренда/мес (€) | Покупка (€) |
| -------------------------- | ---------------------------------------------------- | --------- | -------------- | -------------- | ----------- |
| **Kubernetes Worker Node** | 1U AMD EPYC 9124P, 128 cores, 512 GB RAM, 2×NVMe 4TB | 128       | 2              | €2 500         | €20 000     |
| **PGSQL Node**             | 2U AMD EPYC 7543P, 64 cores, 512 GB RAM, 8×NVMe 8TB  | 64        | 1              | €3 500         | €25 000     |
| **Redis Node**             | 1U AMD EPYC 7302P, 16 cores, 128 GB RAM, 2×NVMe 2TB  | 16        | 1              | €800           | €7 000      |
| **ClickHouse Node**        | 1U AMD EPYC 7543P, 32 cores, 256 GB RAM, 4×NVMe 4TB  | 32        | 1              | €1 200         | €12 000     |
| **ElasticSearch Node**     | 1U AMD EPYC 7543P, 32 cores, 256 GB RAM, 4×NVMe 4TB  | 32        | 2              | €2 400         | €24 000     |
| **Kafka Broker**           | 1U AMD EPYC 7302P, 16 cores, 128 GB RAM, 2×NVMe 2TB  | 16        | 1              | €800           | €7 000      |
